      ...
      <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-12">
        ...
        <div className="flex flex-col h-full">
          ...
          <nav className="grid grid-cols-2 gap-y-4 gap-x-8 mb-12">
            <a href="/#hero" className="text-[#4B5563] hover:text-[#0D9488] transition-colors font-medium text-base">首頁</a>
            <a href="/#product" className="text-[#4B5563] hover:text-[#0D9488] transition-colors font-medium text-base">什麼是 BusyCow</a>
            <a href="/use-cases" className="text-[#4B5563] hover:text-[#0D9488] transition-colors font-medium text-base">應用情境</a>
            <a href="/#pricing" className="text-[#4B5563] hover:text-[#0D9488] transition-colors font-medium text-base">價格方案</a>
            <a href="/#testimonials" className="text-[#4B5563] hover:text-[#0D9488] transition-colors font-medium text-base">成功案例</a>
            <a href="/#contact" className="text-[#4B5563] hover:text-[#0D9488] transition-colors font-medium text-base">聯絡我們</a>
          </nav>
